      ...
      <div className="max-w-2xl mx-auto px-6 py-12 sm:py-16">
        ...
        <article className="prose prose-gray max-w-none opacity-0 animate-slide-up" style={{ animationFillMode: "forwards" }}>
          ...
          <section className="mb-8">
            ...
            <p className="text-label-secondary mb-4">
              Before you buy, run the numbers through conservative underwriting. Get a clear verdict (Proceed, Borderline, Walk Away) and a fragility explanation. If the deal is borderline, know exactly what would have to go right and whether you can stomach the downside. For why many calculators overestimate in the first place, read <Link href="/learn/why-str-calculators-overestimate" className="text-accent hover:text-accent-hover underline">why STR calculators overestimate revenue</Link>. See the <TrackedSampleLink sourceArticle="str-fragility-checklist" className="text-accent hover:text-accent-hover underline">sample report</TrackedSampleLink> or <Link href="/" className="text-accent hover:text-accent-hover underline">run your deal</Link>.
            </p>
          </section>
